...
void CDPLoginClient::OnPreJoin( CAr & ar )
{
	...
	// Open world here.	
	WriteLog( "Joining World Server - Character: %s, WorldID: %d, Account: %s",
		g_Neuz.m_apPlayer[m_nSlot] ? g_Neuz.m_apPlayer[m_nSlot]->GetName() : "Unknown",
		g_Neuz.m_adwWorldID[m_nSlot], g_Neuz.m_szAccount );
